...
function countField(id: string, key: string, label: string): TemplateField {
  return {
    id,
    key,
    label,
    ...
    options: Array.from(
      ...
      (_, index) => {
        ...
        return {
          value,
          label: `${value} ${Number(value) === 1 ? "person" : "people"}`,
        };
      },
    ),
  };
...
function signature(
  id: string,
  label: string,
  repeat?: Extract<TemplateBlock, { type: "signature" }>["repeat"],
): TemplateBlock {
...
function directorRepeater(): TemplateRepeater {
  return {
    ...
    itemLabel: "Director",
    description:
      "Starts at two directors and supports up to eight. Only the selected director count appears in the document.",
    countFieldKey: "director_count",
    minItems: privateCompanyMinPeople,
    maxItems: privateCompanyMaxPeople,
    fields: [
      field(
        "private-company-director-name",
        "name",
        "Full legal name",
        "text",
      ...
      field(
        "private-company-director-details",
        "details",
        "Identity and address",
        "textarea",
        "Father or spouse, NID or passport, nationality and address",
        false,
      ),
      field(
        "private-company-director-role",
        "role",
        "Role or designation",
        "text",
        "Director",
...
function subscriberRepeater(): TemplateRepeater {
  return {
    ...
    description:
      "Starts at two subscribers and supports up to eight. Each selected subscriber receives a signature line on the execution page.",
    countFieldKey: "subscriber_count",
    minItems: privateCompanyMinPeople,
    maxItems: privateCompanyMaxPeople,
    fields: [
      field(
        "private-company-subscriber-name",
        "name",
        "Full legal name",
        "text",
      ...
      field(
        "private-company-subscriber-address",
        "address",
        "Address",
        "textarea",
        "Full address",
      ...
      field(
        "private-company-subscriber-occupation",
        "occupation",
        "Occupation",
        "text",
        "Occupation",
      ...
      field(
        "private-company-subscriber-shares",
        "shares",
        "Number of shares",
        "number",
...
const companyFields: TemplateField[] = [
  ...
  field(
    "private-company-capital-words",
    "authorised_capital_words",
    "Authorised capital in words",
    "text",
    "Forty lakh taka",
  ),
  field(
    "private-company-share-count",
    "share_count",
  ...
  field(
    ...
    "share_value",
    "Nominal value per share (BDT)",
    "number",
    "100",
  ),
  field(
    "private-company-share-value-words",
    "share_value_words",
    "Nominal share value in words",
    "text",
    "One hundred taka",
  ),
  field(
    ...
    "additional_objects",
    "Additional business objects (optional)",
    "textarea",
    "Add any company-specific object clauses that should appear after the source draft clauses.",
    false,
  ),
  countField(
    "private-company-director-count",
    "director_count",
    "Number of first directors",
  ),
  field(
    "private-company-chairman",
    "chairman_name",
    "First Chairman",
    "text",
    "Full legal name",
  ...
  field(
    "private-company-bank-rule",
    "bank_operation_rule",
    "Bank-account operating rule",
    "textarea",
    "For example: jointly by the Managing Director and any two Directors",
    false,
  ),
  countField(
    "private-company-subscriber-count",
    "subscriber_count",
    "Number of subscribers",
  ),
  field(
    "private-company-witness-one",
    "witness_one",
    "Witness 1",
    "textarea",
...
const memorandumPages: TemplatePage[] = [
  page(1, "Cover", [
    ...
    text("cover-act", "title", "THE COMPANIES ACT, 1994", {
      fontSize: "subtitle",
    }),
    text("cover-act-number", "paragraph", "(ACT XVIII OF 1994)", {
      align: "center",
      bold: true,
      fontSize: "body",
    }),
    spacer("cover-company-space", 78),
    text("cover-company-type", "title", "A PRIVATE COMPANY LIMITED BY SHARES", {
      fontSize: "subtitle",
    }),
    spacer("cover-moa-space", 78),
    text("cover-moa", "title", "MEMORANDUM OF ASSOCIATION", {
      fontSize: "subtitle",
    }),
    text("cover-and", "paragraph", "AND", {
      align: "center",
      bold: true,
      fontSize: "body",
    }),
    text("cover-aoa", "title", "ARTICLES OF ASSOCIATION", {
      fontSize: "subtitle",
    }),
    text("cover-of", "paragraph", "OF", {
      align: "center",
      bold: true,
      fontSize: "body",
    }),
    spacer("cover-name-space", 44),
    text("cover-company-name", "title", "{{company_name}}", {
      fontSize: "subtitle",
    }),
  ]),
  page(2, "Memorandum of Association", [
    ...
    text("moa-title", "title", "MEMORANDUM OF ASSOCIATION", {
      fontSize: "subtitle",
    }),
    text("moa-of", "paragraph", "OF {{company_name}}", {
      align: "center",
      bold: true,
      fontSize: "body",
    }),
...
const articlesPages: TemplatePage[] = [
  page(6, "Articles Cover", [
    ...
    text("aoa-cover-act", "title", "THE COMPANIES ACT, 1994", {
      fontSize: "subtitle",
    }),
    text(
      "aoa-cover-act-number",
      "paragraph",
      "(ACT XVIII OF 1994)\n(A PRIVATE COMPANY LIMITED BY SHARES)",
      { align: "center", bold: true, fontSize: "body" },
    ),
    spacer("aoa-cover-title-space", 94),
    text("aoa-cover-title", "title", "ARTICLES OF ASSOCIATION", {
      fontSize: "subtitle",
    }),
    text("aoa-cover-of", "paragraph", "OF", {
      align: "center",
      bold: true,
      fontSize: "body",
    }),
    spacer("aoa-cover-name-space", 42),
    text("aoa-cover-company", "title", "{{company_name}}", {
      fontSize: "subtitle",
    }),
  ]),
  page(7, "Articles 1 to 3", [
    ...
    text(
      "aoa-article-two",
      "paragraph",
      "2. Unless the context otherwise requires, words or expressions contained in these Articles shall bear the same meaning as in the Act or any statutory modification thereof in force at the date at which these Articles, or any other Articles from time to time framed by the Company, apply. In these presents, unless there is something in the subject or context inconsistent therewith: “The Act” means the Companies Act, 1994. “The Company” means {{company_name}}. “The Directors” means the Directors for the time being of the Company. “The Board of Directors” or “the Board” means the Board of Directors for the time being of the Company. “The Managing Director” means the Managing Director appointed as such for the time being of the Company. “The Office” means the Registered Office for the time being of the Company.",
      { bold: false },
    ),
    text(
      "aoa-article-three",
      "paragraph",
      "3. “Register” means the Register of Members to be kept pursuant to section 34 of the Act. “The Registrar” means the Registrar of Joint Stock Companies, Bangladesh. “Dividend” includes bonus. “Month” means calendar month. “Seal” means the Common Seal of the Company. “Proxy” includes an attorney duly constituted under a power of attorney. “In Writing” and “Written” include printing, lithography and other modes of representing or reproducing words in visible form. Words importing the singular include the plural and vice versa; words importing the masculine include the feminine and vice versa; and words importing persons include corporations and companies.",
      { bold: false },
    ),
  ]),
  page(8, "Articles 4 to 6", [
    ...
    text(
      "aoa-article-five",
      "paragraph",
      "5. The business of the Company may be commenced as soon after incorporation as the Board shall think fit.",
      { bold: false },
    ),
  ...
  page(9, "Articles 7 to 10", [
    ...
    text(
      "aoa-article-nine",
      "paragraph",
      "9. Every person whose name is entered in the Register of Members shall be entitled to one or more share certificates issued under the common seal of the Company, specifying the number of shares held and the amount paid thereon. In respect of shares held jointly, the Company is not bound to issue more than one certificate and delivery to one of the joint holders, preferably the holder whose name stands first in the Register of Members, shall be sufficient delivery to all. A defaced, lost or destroyed certificate may be reissued on such terms and conditions as the Directors think fit.",
      { bold: false },
    ),
  ...
  page(10, "Articles 11 to 14", [
    text(
      "aoa-article-eleven",
      "paragraph",
      "11. Any person entitled to a share in consequence of the death or insolvency of a member shall, upon producing such evidence as the Directors may require, have the right to be registered as a member in respect of that share. Any share may, subject to approval of the Directors, be transferred by a member to that member’s spouse, son, daughter, father, mother or brother.",
      { bold: false },
    ),
    text(
      "aoa-article-twelve",
      "paragraph",
      "12. Subject to the preceding provisions, shares of the Company shall not be transferred by a member to any person so long as a member or another person selected by the Directors is willing to purchase them at a reasonable price fixed mutually by transferor and transferee. The Directors may decline to register a transfer of shares to a person whom they do not approve for a reason appearing to them just and proper in the interest of the Company, and are not bound to disclose or assign that reason.",
      { bold: false },
    ),
    clauseHeading("aoa-increase-capital", "INCREASE OF SHARE CAPITAL"),
    text(
      "aoa-article-thirteen",
      "paragraph",
      "13. The Directors may, with the sanction of an ordinary resolution of the Company previously passed in general meeting, increase share capital by issuing new shares. The increase shall be of such amount and divided into shares of such respective value as the Company in meeting may direct and, if no direction is given, as the Directors think fit.",
      { bold: false },
    ),
    clauseHeading("aoa-borrowing", "BORROWING POWERS"),
    text(
      "aoa-article-fourteen",
      "paragraph",
      "14. The Directors may from time to time borrow from any source any sum required for the purposes of the Company and raise and secure payment in such manner and upon such terms and conditions as they think fit, including by the issue of shares, making, drawing, accepting or endorsing promissory notes or bills of exchange, issuing securities, or creating a mortgage, charge or hypothecation over any property of the Company, present or future, including uncalled capital. The Directors may on behalf of the Company guarantee the whole or any part of loans or debts incurred by the Company and secure a guarantor against liability in respect of those loans or debts.",
      { bold: false },
    ),
  ]),
  page(11, "Articles 15 to 18", [
    ...
    text(
      "aoa-article-fifteen",
      "paragraph",
      "15. The first ordinary general meeting of the Company shall be held within eighteen months from the date of incorporation and thereafter once in every calendar year, at a time not more than fifteen months after the last preceding general meeting and at such time and place as the Directors determine. All other meetings of the Company shall be called extraordinary general meetings.",
      { bold: false },
    ),
    text(
      "aoa-article-sixteen",
    ...
    text(
      "aoa-article-seventeen",
      "paragraph",
      "17. The business of the ordinary general meeting shall be to receive and consider profit and loss accounts, the balance sheet and the reports of Directors and Auditors; appoint Auditors; elect Directors; declare dividends; and transact any other business which ought to be transacted by the Company. At any general meeting, a resolution put to vote shall be decided by show of hands or by poll. An entry to that effect in the book of proceedings of the Company shall be conclusive evidence of the facts without proof of the number or proportion of votes recorded in favour of or against the resolution.",
      { bold: false },
    ),
    text(
      "aoa-article-eighteen",
      "paragraph",
      "18. The Chairperson of the meeting elected by members present may, with the consent of members, adjourn the meeting from time to time and from place to place, but no business shall be transacted at an adjourned meeting other than business left unfinished at the meeting from which the adjournment took place. No business shall be transacted at any general meeting unless there is a quorum, and the meeting shall stand adjourned until such time as the members present decide.",
      { bold: false },
    ),
  ]),
  page(12, "Articles 19 to 22", [
    ...
    text(
      "aoa-article-nineteen",
      "paragraph",
      "19. Two members present in person or by proxy shall form a quorum at any general meeting. The members present shall elect one among themselves to act as Chairperson of the meeting. The Chairperson so elected shall preside over the meeting and, in the case of equality of votes, shall have a second or casting vote.",
      { bold: false },
    ),
    ...
    text(
      "aoa-article-twenty",
      "paragraph",
      "20. Two members present in person and qualified to vote shall form a quorum. Whenever the Board of Directors thinks it necessary, it may call a general meeting, whether ordinary or extraordinary, at such time, subject to section 84 of the Act, and place as the Board thinks fit.",
      { bold: false },
    ),
    clauseHeading("aoa-vote", "VOTE OF MEMBERS"),
    text(
      "aoa-article-twenty-one",
      "paragraph",
      "21. On a show of hands every member present in person and entitled to vote shall have one vote and, upon a poll, every member present in person or by proxy or power of attorney shall have one vote in respect of every share held. On a poll, a vote may be given personally, by proxy, under power of attorney or by a person appointed under section 86 of the Companies Act, 1994. A proxy must be a member of the Company. No member shall be entitled to vote at any general meeting unless all calls or other sums presently payable by that member to the Company in respect of shares held have been paid.",
      { bold: false },
    ),
    text(
      "aoa-article-twenty-two",
      "paragraph",
      "22. Any person entitled under the transmission clause to the transfer of a share may vote at any general meeting in the same manner as if registered holder, provided that at least forty-eight hours before the meeting or adjourned meeting at which that person proposes to vote, the Directors are satisfied of that person’s rights as transferee, unless the Board of Directors or Managing Director has previously admitted that right to vote.",
      { bold: false },
    ),
  ]),
  page(13, "Articles 23 and 24", [
    ...
    text(
      "aoa-article-twenty-three",
      "paragraph",
      "23. Until otherwise determined by the Company in general meeting, the number of Directors shall not be less than two and not more than fifty. The following persons shall be the first and permanent Directors of the Company unless any one voluntarily resigns the office or is otherwise removed under section 108(1) of the Companies Act, 1994:",
      { bold: false },
    ),
    text(
      "aoa-director-list",
      "paragraph",
      "{{item_number}}. {{name}}\n{{details}} {{role}}",
      { bold: false, repeat: { repeaterKey: "directors" } },
    ),
    clauseHeading("aoa-qualification", "QUALIFICATION OF SHARES"),
    text(
      "aoa-article-twenty-four",
      "paragraph",
      "24. The qualification of a Director of the Company shall be holding, in that Director’s own name or in the name of the Company or shareholder represented, ordinary shares of BDT 1,000 (one thousand) in value, each share being BDT {{share_value}} ({{share_value_words}}), unless otherwise determined in accordance with law. The quorum necessary for transaction of business by the Directors may be fixed and changed by the Directors from time to time.",
      { bold: false },
    ),
  ]),
  ...
  page(16, "Corporate Administration", [
    ...
    text(
      "aoa-bank-account-clause",
      "paragraph",
      "The Company shall have authority to open, maintain and operate one or more bank accounts with scheduled banks and/or foreign banks. {{bank_operation_rule}}",
      { bold: false },
    ),
    ...
    text(
      "aoa-fund-clause",
      "paragraph",
      "All moneys of the Company may be kept in such places or banks as the Board of Directors directs and may be taken from there by cheque or receipt. It shall be sufficient if the cheque or receipt is signed by the Managing Director or by two Directors and bears the seal of the Company.",
      { bold: false },
    ),
    ...
    text(
      "aoa-secrecy-clause",
      "paragraph",
      "Directors, Managers, Secretaries, officers, Auditors, agents and other persons employed in the business of the Company shall observe strict secrecy respecting matters that come to their knowledge in discharge of their duties, when required by a resolution of the Company, a court of law, any provision of law or these Articles.",
      { bold: false },
    ),
  ...
  page(18, "Subscribers and Execution", [
    ...
    text("execution-title", "title", "SUBSCRIBERS AND EXECUTION", {
      fontSize: "subtitle",
    }),
    text(
      "execution-company",
    ...
    text(
      "execution-intro",
      "paragraph",
      "We, the several persons whose names and particulars are subscribed below, wish to be formed into a Company pursuant to this Memorandum of Association and agree to take the number of shares set opposite our respective names.",
      { bold: false },
    ),
    text(
      "execution-subscriber-details",
      "paragraph",
      "Subscriber {{item_number}} — {{name}}\n{{address}} {{occupation}}\nShares: {{shares}}",
      { bold: false, repeat: { repeaterKey: "subscribers" } },
    ),
    clauseHeading("execution-signatures", "SIGNATURES"),
    signature(
      "execution-subscriber-signature",
      "Subscriber {{item_number}} — {{name}}",
      { repeaterKey: "subscribers" },
    ),
...
export const defaultPrivateCompanyMoaAoaTemplate: DocumentTemplateDraft = {
  ...
  description:
    "A source-based private-company Memorandum and Articles of Association draft with editable company, capital, director and subscriber details.",
