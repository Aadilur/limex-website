...
function toPageContent(
  ...
  return {
    ...
    breadcrumb:
      locale === "bn"
        ? `হোম / সেবাসমূহ / ${service.title}`
        : `Home / Services / ${service.title}`,
    breadcrumbItems: [
      { label: locale === "bn" ? "হোম" : "Home", href: "/" },
      {
        label: locale === "bn" ? "সেবাসমূহ" : "Services",
        href: locale === "bn" ? "/bn/services" : "/services",
      },
      { label: service.title },
    ],
    category:
      locale === "bn" ? service.category : service.category.toUpperCase(),
    title: service.title,
