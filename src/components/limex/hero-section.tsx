...
export function HeroSection({ content = defaultLandingContent.hero }: { content?: HeroContent }) {
  return (
    <section className="relative flex min-h-0 flex-col overflow-hidden rounded-[20px] bg-page lg:min-h-hero-home lg:rounded-[28px]" id="top" aria-labelledby="hero-title">
      ...
      <div className="relative z-[1] shrink-0 px-5 pt-hero-content-top-separated text-center max-[560px]:pt-hero-content-top-separated-sm lg:absolute lg:left-1/2 lg:top-hero-content-top-separated-lg lg:w-[min(930px,calc(100%-48px))] lg:-translate-x-1/2 lg:px-0 lg:pt-0">
        <p className="mx-auto max-w-[500px] text-overline text-[#52545c] max-[560px]:hidden lg:max-w-none lg:text-kicker">{content.eyebrow}</p>
        <p className="mx-auto hidden max-w-[320px] text-meta font-display uppercase tracking-[0.1em] text-[#2b5e8c] max-[560px]:block">{content.mobileEyebrow}</p>
        <h1 className="my-5 flex flex-col font-brand text-hero-mobile text-ink max-[560px]:my-4 sm:text-hero-tablet wide:text-hero lg:my-hero-title-gap lg:mb-[22px]" id="hero-title">
          <span className="text-accent">{content.titlePrimary}</span>
          <em className="font-normal not-italic text-[#576378] underline decoration-wavy decoration-[1px] underline-offset-[5px]">{content.titleSecondary}</em>
        </h1>
        <p className="mx-auto max-w-[520px] text-body-sm text-[#52545c] lg:max-w-[620px] lg:text-body">{content.description}</p>
        <div className="mt-hero-action-gap grid w-full max-w-[338px] grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] gap-3 max-[380px]:grid-cols-1 lg:flex lg:max-w-none lg:items-center lg:justify-center lg:gap-nav lg:mt-hero-action-gap-lg">
          <ActionButton href={content.primaryCtaHref} variant="dark" arrow="text" className="min-h-control w-full min-w-0 justify-center gap-2 whitespace-nowrap border-[#071b3d] bg-[#071b3d] px-3 text-button text-white shadow-[0_10px_22px_rgba(20,19,26,0.12)] hover:border-[#25222e] hover:bg-[#25222e] hover:shadow-[0_14px_28px_rgba(20,19,26,0.16)] lg:h-button-lg lg:w-[185px] lg:gap-cluster-sm lg:px-[22px] lg:shadow-[0_12px_26px_rgba(20,19,26,0.14)] lg:hover:bg-[#25222e] lg:hover:shadow-[0_16px_32px_rgba(20,19,26,0.18)]">
            {content.primaryCtaLabel}
          </ActionButton>
          <ActionButton href={content.secondaryCtaHref} variant="outline" arrow="none" className="min-h-control w-full min-w-0 justify-center whitespace-nowrap border-[#c9c0c4] bg-white/55 px-3 text-button text-ink shadow-none hover:border-accent hover:bg-white/75 hover:shadow-none lg:h-button-lg lg:w-[170px] lg:bg-white/85 lg:px-4 lg:shadow-[0_8px_20px_rgba(67,56,65,0.06)] lg:hover:bg-white lg:shadow-none lg:hover:bg-white lg:hover:shadow-[0_12px_24px_rgba(67,56,65,0.1)]">
