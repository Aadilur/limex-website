...
function FieldInput({ field, value, onChange }: { field: TemplateField | TemplateRepeaterField; value: string; onChange: (value: string) => void }) {
  const label = <span className="mb-1.5 block text-[12px] font-bold uppercase tracking-[0.12em] text-[#6f6961]">{field.label}{field.required ? <span className="ml-1 text-[#e44762]">*</span> : null}</span>;
